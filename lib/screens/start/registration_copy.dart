...
//   bool get _emailIsVerified => VERIFIED_EMAILS.contains(information["email"]);
...
//     if (_providerPhotoURL != null && _haveProviderImageError.isFalse) {
//       return CachedNetworkImageProvider(_providerPhotoURL!);
//     }
...
//         var email = information['email'].toString();

//         if (!VERIFIED_EMAILS.contains(email)) VERIFIED_EMAILS.add(email);
...
//                                         TextButton(
//                                           onPressed: () {
//                                             controller._providerPhotoURL = null;
