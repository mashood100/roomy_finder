...
// import 'package:roomy_finder/screens/chat/flyer_chat.dart';
...
//           saveNotification(msg.data["event"], message, isForeground);
//         }
...
//         }
//       } else {
//         AppController.staticIncrementBadge("messages");
//       }
//     } catch (e, trace) {
//       Get.log("$e");
//       Get.log("$trace");
...
//       if (isForegound) {
//         AppController.instance.incrementBadge("notifications");
//       } else {
